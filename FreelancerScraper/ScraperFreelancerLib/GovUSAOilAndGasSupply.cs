...
{
    public class GovUSAOilAndGasSupply : ExcelXlsxScrapeData
    {
        public const string URL = "https://www.eia.gov/outlooks/aeo/excel/aeotab_14.xlsx";
        ...
        {            
            ...
            for (int rowIdx = firstRowWithData; rowIdx <= lastRow; rowIdx++)
            {
                ...
                for (int cellIdx = cellShift; cellIdx <= lastCellWithData; cellIdx++)
                {
                    ...
                    string prefixName = "";
                    if (rowIdx == 18)
                        prefixName = "Crude Oil Lower 48 Average Wellhead Price 1/ (2016 dollars per barrel) ";
                    if (rowIdx >= 21 && rowIdx <= 32)
                        prefixName = "Crude Oil Production (million barrels per day) 2/ ";
                    if (rowIdx >= 36 && rowIdx <= 39)
                        prefixName = "Crude Oil Natural Gas Plant Liquids Production (million barrels per day) ";
                    if (rowIdx == 44)
                        prefixName = "Natural Gas Prices (2016 dollars per million Btu) ";
                    if (rowIdx >= 47 && rowIdx <= 56)
                        prefixName = "Natural Gas Dry Production (trillion cubic feet) 4/ ";
                    if (rowIdx == 58 || rowIdx == 60)
                        prefixName = "Natural Gas ";

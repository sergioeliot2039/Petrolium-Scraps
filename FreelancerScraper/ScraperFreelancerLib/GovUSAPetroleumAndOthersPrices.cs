...
{
    public class GovUSAPetroleumAndOthersPrices : ExcelXlsxScrapeData
    {
        public const string URL = "https://www.eia.gov/outlooks/aeo/excel/aeotab_12.xlsx";
            ...
            for (int rowIdx = firstRowWithData; rowIdx <= lastRow; rowIdx++)
            {
                ...
                for (int cellIdx = cellShift; cellIdx <= lastCellWithData; cellIdx++)
                {
                    ...
                    if (rowIdx >= 16 && rowIdx <= 19)
                        prefixName = "Crude Oil Prices (2016 dollars per barrel) ";
                    if (rowIdx >= 24 && rowIdx <= 25)
                        prefixName = "Delivered Sector Product Prices Residential ";
                    if (rowIdx >= 28 && rowIdx <= 30)
                        prefixName = "Delivered Sector Product Prices Commercial ";
                    if (rowIdx >= 33 && rowIdx <= 36)
                        prefixName = "Delivered Sector Product Prices Industrial 2/ ";
                    if (rowIdx >= 39 && rowIdx <= 46)
                        prefixName = "Delivered Sector Product Prices Transportation ";
                    if (rowIdx >= 48 && rowIdx <= 51)
                        prefixName = "Delivered Sector Product Prices Electric Power 7/ ";
                    if (rowIdx >= 54 && rowIdx <= 60)
                        prefixName = "Delivered Sector Product Prices Average Prices, All Sectors 8/ ";
                    if (rowIdx >= 65 && rowIdx <= 67)
                        prefixName = "Prices in Nominal Dollars Crude Oil Spot Prices (nominal dollars per barrel) ";
                    if (rowIdx >= 72 && rowIdx <= 73)
                        prefixName = "Prices in Nominal Dollars Delivered Sector Product Prices (nominal dollars per Gallon) Residential ";
                    if (rowIdx >= 76 && rowIdx <= 77)
                        prefixName = "Prices in Nominal Dollars Delivered Sector Product Prices (nominal dollars per Gallon) Commercial ";
                    if (rowIdx >= 80 && rowIdx <= 82)
                        prefixName = "Prices in Nominal Dollars Delivered Sector Product Prices (nominal dollars per Gallon) Industrial 2/ ";
                    if (rowIdx >= 85 && rowIdx <= 91)
                        prefixName = "Prices in Nominal Dollars Delivered Sector Product Prices (nominal dollars per Gallon) Transportation ";
                    if (rowIdx >= 94 && rowIdx <= 95)
                        prefixName = "Prices in Nominal Dollars Delivered Sector Product Prices (nominal dollars per Gallon)  Electric Power 7/ ";
                    if (rowIdx >= 98 && rowIdx <= 103)
                        prefixName = "Prices in Nominal Dollars Delivered Sector Product Prices (nominal dollars per Gallon)  Average Prices, All Sectors 8/ ";

...
{
    public class GovUSAElectricityDispositionPriceEmission : ExcelXlsxScrapeData
    {
        public const string URL = "https://www.eia.gov/outlooks/aeo/excel/aeotab_8.xlsx";
        ...
        protected override void ScrapeXlsx(ScraperDbContext dbContext, DateTime lastModified, XLWorkbook xlsx)
        {
            ...
            for (int rowIdx = firstRowWithData; rowIdx <= lastRow; rowIdx++)
            {
                ...
                for (int cellIdx = cellShift; cellIdx <= lastCellWithData; cellIdx++)
                {
                    ...
                    string prefixName = "";
                    if (rowIdx >= 19 && rowIdx <= 26)
                        prefixName = "Electric Power Sector 1/ Power Only 2/ ";
                    if (rowIdx >= 28 && rowIdx <= 34)
                        prefixName = "Electric Power Sector 1/ Combined Heat and Power 6/ ";
                    if (rowIdx == 36)
                        prefixName = "Electric Power Sector 1/ Net Available to the Grid ";
                    if (rowIdx >= 39 && rowIdx <= 47)
                        prefixName = "End-Use Sector 7/ ";
                    if (rowIdx >= 50 && rowIdx <= 57)
                        prefixName = "End-Use Sector 7/ Total Net Electricity Generation by Fuel ";
                    if (rowIdx == 59)
                        prefixName = "End-Use Sector 7/ Total Net Electricity Generation by Fuel ";
                    if (rowIdx >= 62 && rowIdx <= 68)
                        prefixName = "End-Use Sector 7/ Electricity Sales by Sector ";
                    if (rowIdx >= 72 && rowIdx <= 76)
                        prefixName = "End-Use Sector 7/ End-Use Prices (2016 cents per kilowatthour) ";
                    if (rowIdx >= 78 && rowIdx <= 82)
                        prefixName = "End-Use Sector 7/ End-Use Prices (nominal cents per kilowatthour) ";
                    if (rowIdx >= 86 && rowIdx <= 88)
                        prefixName = "End-Use Sector 7/ Prices by Service Category (2016 cents per kilowatthour) ";
                    if (rowIdx >= 90 && rowIdx <= 92)
                        prefixName = "End-Use Sector 7/ Prices by Service Category (nominal cents per kilowatthour) ";
                    if (rowIdx >= 95 && rowIdx <= 97)
                        prefixName = "Electric Power Sector Emissions 1/ ";

...
{
    public class GovUSAAnnualProjectionEnergySummary : ExcelXlsxScrapeData
    {
        public const string URL = "https://www.eia.gov/outlooks/aeo/excel/aeotab_1.xlsx";
        ...
        protected override void ScrapeXlsx(ScraperDbContext dbContext, DateTime lastModified, XLWorkbook xlsx)
        {
            ...
            for (int rowIdx = firstRowWithData; rowIdx <= lastRow; rowIdx++)
            {
                ...
                for (int cellIdx = cellShift; cellIdx <= lastCellWithData; cellIdx++)
                {
                    ...
                    string prefixName = "";
                    if (rowIdx >= 16 && rowIdx <= 25)
                        prefixName = "Production ";
                    if (rowIdx >= 27 && rowIdx <= 32)
                        prefixName = "Imports ";
                    if (rowIdx >= 35 && rowIdx <= 38)
                        prefixName = "Exports ";
                    if (rowIdx >= 43 && rowIdx <= 51)
                        prefixName = "Consumption ";
                    if (rowIdx >= 54 && rowIdx <= 60)
                        prefixName = "Prices (2016 dollars per unit) ";
                    if (rowIdx >= 64 && rowIdx <= 70)
                        prefixName = "Prices (nominal dollars per unit) ";

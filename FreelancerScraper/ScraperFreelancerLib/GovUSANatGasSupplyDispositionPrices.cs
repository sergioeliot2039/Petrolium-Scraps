...
{
    public class GovUSANatGasSupplyDispositionPrices : ExcelXlsxScrapeData
    {
        public const string URL = "https://www.eia.gov/outlooks/aeo/excel/aeotab_13.xlsx";
        ...
        {            
            ...
            for (int rowIdx = firstRowWithData; rowIdx <= lastRow; rowIdx++)
            {
                ...
                for (int cellIdx = cellShift; cellIdx <= lastCellWithData; cellIdx++)
                {
                    ...
                    if (rowIdx >= 26 && rowIdx <= 36)
                        prefixName = "Consumption by Sector ";
                    if (rowIdx >= 26 && rowIdx <= 36)
                        prefixName = "Consumption by Sector ";
                    if (rowIdx == 43 || rowIdx == 54)
                        prefixName = "Natural Gas Prices Natural Gas Spot Price at Henry Hub ";
                    if (rowIdx >= 47 && rowIdx <= 52)
                        prefixName = "Natural Gas Prices Delivered Prices (2016 dollars per thousand cubic feet) ";
                    if (rowIdx >= 58 && rowIdx <= 63)
                        prefixName = "Natural Gas Prices Delivered Prices (nominal dollars per thousand cubic feet) ";

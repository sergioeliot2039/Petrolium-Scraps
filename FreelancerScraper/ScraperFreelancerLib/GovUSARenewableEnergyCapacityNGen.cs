...
{
    public class GovUSARenewableEnergyCapacityNGen : ExcelXlsxScrapeData
    {
        public const string URL = "https://www.eia.gov/outlooks/aeo/excel/aeotab_16.xlsx";
        ...
        {            
            ...
            for (int rowIdx = firstRowWithData; rowIdx <= lastRow; rowIdx++)
            {
                ...
                for (int cellIdx = cellShift; cellIdx <= lastCellWithData; cellIdx++)
                {
                    ...
                    string prefixName = "";
                    if (rowIdx >= 17 && rowIdx <= 25)
                        prefixName = "Electric Power Sector 1/ Net Summer Capacity ";
                    if (rowIdx >= 28 && rowIdx <= 38)
                        prefixName = "Electric Power Sector 1/ Generation (billion kilowatthours) ";
                    if (rowIdx >= 42 && rowIdx <= 48)
                        prefixName = "End-Use Sectors 7/ Net Summer Capacity ";
                    if (rowIdx >= 51 && rowIdx <= 57)
                        prefixName = "End-Use Sectors 7/ Generation (billion kilowatthours) ";
                    if (rowIdx >= 62 && rowIdx <= 68)
                        prefixName = "All Sectors Net Summer Capacity ";
                    if (rowIdx >= 71 && rowIdx <= 77)
                        prefixName = "All Sectors Generation (billion kilowatthours) ";

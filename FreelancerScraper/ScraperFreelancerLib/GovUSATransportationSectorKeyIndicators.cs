...
{
    public class GovUSATransportationSectorKeyIndicators : ExcelXlsxScrapeData
    {
        public const string URL = "https://www.eia.gov/outlooks/aeo/excel/aeotab_7.xlsx";
            ...
            for (int rowIdx = firstRowWithData; rowIdx <= lastRow; rowIdx++)
            {
                ...
                for (int cellIdx = cellShift; cellIdx <= lastCellWithData; cellIdx++)
                {
                    ...
                    if (rowIdx >= 17 && rowIdx <= 20)
                        prefixName = "Key Indicators Travel Indicators (billion vehicle miles traveled) ";
                    if (rowIdx == 22)
                        prefixName = "Key Indicators Travel Indicators (billion seat miles available) ";
                    if (rowIdx >= 24 && rowIdx <= 44)
                        prefixName = "Key Indicators Travel Indicators (billion ton miles traveled) ";
                    if (rowIdx >= 29 && rowIdx <= 44)
                        prefixName = "Key Indicators Energy Efficiency Indicators (miles per gallon) ";
                    if (rowIdx == 46)
                        prefixName = "Key Indicators Energy Efficiency Indicators(seat miles per gallon) ";
                    if (rowIdx >= 48 && rowIdx <= 49)
                        prefixName = "Key Indicators Energy Efficiency Indicators (ton miles/thousand Btu) ";
                    if (rowIdx >= 53 && rowIdx <= 66)
                        prefixName = "Key Indicators Energy Use by Mode (quadrillion Btu) ";
                    if (rowIdx >= 69 && rowIdx <= 82)
                        prefixName = "Key Indicators Energy Use by Mode (million barrels per day oil equivalent) ";

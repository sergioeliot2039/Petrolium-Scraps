...
{
    public class GovUSAIntlPetroleumNOthersSupplyDispositionNPrices : ExcelXlsxScrapeData
    {
        public const string URL = "https://www.eia.gov/outlooks/aeo/excel/aeotab_21.xlsx";
        ...
        {            
            ...
            for (int rowIdx = firstRowWithData; rowIdx <= lastRow; rowIdx++)
            {
                ...
                for (int cellIdx = cellShift; cellIdx <= lastCellWithData; cellIdx++)
                {
                    ...
                    string prefixName = "";
                    if (rowIdx >= 17 && rowIdx <= 18)
                        prefixName = "Crude Oil Spot Prices (2016 dollars per barrel) ";
                    if (rowIdx >= 20 && rowIdx <= 21)
                        prefixName = "Crude Oil Spot Prices (nominal dollars per barrel) ";
                    if (rowIdx >= 25 && rowIdx <= 33)
                        prefixName = "Petroleum and Other Liquids Consumption 1/ OECD ";
                    if (rowIdx >= 35 && rowIdx <= 44)
                        prefixName = "Petroleum and Other Liquids Consumption 1/ Non-OECD ";
                    if (rowIdx == 46)
                        prefixName = "Petroleum and Other Liquids Consumption 1/ ";
                    if (rowIdx >= 50 && rowIdx <= 54)
                        prefixName = "Petroleum and Other Liquids Production OPEC 5/ ";
                    if (rowIdx >= 57 && rowIdx <= 63)
                        prefixName = "Petroleum and Other Liquids Production Non-OPEC OECD ";
                    if (rowIdx >= 65 && rowIdx <= 73)
                        prefixName = "Petroleum and Other Liquids Production Non-OPEC Non-OECD ";
                    if (rowIdx >= 75 && rowIdx <= 76)
                        prefixName = "Petroleum and Other Liquids Production ";
                    if (rowIdx >= 80 && rowIdx <= 88)
                        prefixName = "Selected World Production Subtotals ";
                    if (rowIdx >= 92 && rowIdx <= 96)
                        prefixName = "Crude Oil Production 6/ OPEC 5/ ";
                    if (rowIdx >= 99 && rowIdx <= 105)
                        prefixName = "Crude Oil Production 6/ Non-OPEC OECD ";
                    if (rowIdx >= 107 && rowIdx <= 115)
                        prefixName = "Crude Oil Production 6/ Non-OPEC Non-OECD ";
                    if (rowIdx >= 117 && rowIdx <= 118)

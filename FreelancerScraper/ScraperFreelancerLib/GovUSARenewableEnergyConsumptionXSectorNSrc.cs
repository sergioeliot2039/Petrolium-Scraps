...
{
    public class GovUSARenewableEnergyConsumptionXSectorNSrc : ExcelXlsxScrapeData
    {
        public const string URL = "https://www.eia.gov/outlooks/aeo/excel/aeotab_17.xlsx";
        ...
        {            
            ...
            for (int rowIdx = firstRowWithData; rowIdx <= lastRow; rowIdx++)
            {
                ...
                for (int cellIdx = cellShift; cellIdx <= lastCellWithData; cellIdx++)
                {
                    ...
                    string prefixName = "";
                    if (rowIdx == 17 || rowIdx == 19 || rowIdx == 21 || rowIdx == 27 || rowIdx == 35 || rowIdx == 46)
                        prefixName = "Marketed Renewable Energy 1/ ";
                    if (rowIdx >= 22 && rowIdx <= 25)
                        prefixName = "Marketed Renewable Energy 1/ Industrial 2/ ";
                    if (rowIdx >= 28 && rowIdx <= 33)
                        prefixName = "Marketed Renewable Energy 1/ Transportation ";
                    if (rowIdx >= 36 && rowIdx <= 44)
                        prefixName = "Marketed Renewable Energy 1/ Electric Power 6/ ";
                    if (rowIdx >= 49 && rowIdx <= 52)
                        prefixName = "Marketed Renewable Energy 1/ Sources of Ethanol ";
                    if (rowIdx == 58 || rowIdx == 64)
                        prefixName = "Nonmarketed Renewable Energy 8/ Selected Consumption ";
                    if (rowIdx >= 59 && rowIdx <= 62)
                        prefixName = "Nonmarketed Renewable Energy 8/ Selected Consumption Residential ";
                    if (rowIdx >= 65 && rowIdx <= 67)
                        prefixName = "Nonmarketed Renewable Energy 8/ Selected Consumption Commercial ";

...
{
    public class GovUSAEnergyRelatedCO2EmissionsXEndUse : ExcelXlsxScrapeData
    {
        public const string URL = "https://www.eia.gov/outlooks/aeo/excel/aeotab_19.xlsx";
        ...
        {            
            ...
            for (int rowIdx = firstRowWithData; rowIdx <= lastRow; rowIdx++)
            {
                ...
                for (int cellIdx = cellShift; cellIdx <= lastCellWithData; cellIdx++)
                {
                    ...
                    string prefixName = "";
                    if (rowIdx >= 16 && rowIdx <= 31)
                        prefixName = "Residential ";
                    if (rowIdx >= 34 && rowIdx <= 44)
                        prefixName = "Commercial ";
                    if (rowIdx >= 49 && rowIdx <= 65)
                        prefixName = "Industrial 8/ Manufacturing ";
                    if (rowIdx >= 49 && rowIdx <= 65)
                        prefixName = "Industrial 8/ Manufacturing ";
                    if (rowIdx >= 67 && rowIdx <= 72)
                        prefixName = "Industrial 8/ Nonmanufacturing ";
                    if (rowIdx >= 74 && rowIdx <= 89)
                        prefixName = "Transportation ";
                    if (rowIdx >= 93 && rowIdx <= 102)
                        prefixName = "Biogenic Energy Combustion 10/ ";

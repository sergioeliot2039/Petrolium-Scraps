...
{
    public class GovUSAAnnualProjectionEnergyConsumptionXSectorNSrc : ExcelXlsxScrapeData
    {
        public const string URL = "https://www.eia.gov/outlooks/aeo/excel/aeotab_2.xlsx";
            ...
            for (int rowIdx = firstRowWithData; rowIdx <= lastRow; rowIdx++)
            {
                ...
                for (int cellIdx = cellShift; cellIdx <= lastCellWithData; cellIdx++)
                {
                    ...
                    if (rowIdx >= 76 && rowIdx <= 94)
                        prefixName = "Refining Consumption ";
                    if (rowIdx >= 97 && rowIdx <= 123)
                        prefixName = "Total Industrial Sector Consumption ";
                    if (rowIdx >= 132 && rowIdx <= 159)
                        prefixName = "Total Energy Consumption ";

...
{
    public class GovUSAMacroeconomicIndicators : ExcelXlsxScrapeData
    {
        public const string URL = "https://www.eia.gov/outlooks/aeo/excel/aeotab_20.xlsx";
        ...
        {            
            ...
            for (int rowIdx = firstRowWithData; rowIdx <= lastRow; rowIdx++)
            {
                ...
                for (int cellIdx = cellShift; cellIdx <= lastCellWithData; cellIdx++)
                {
                    ...
                    string prefixName = "";
                    if (rowIdx >= 17 && rowIdx <= 21)
                        prefixName = "Components of Real Gross Domestic Product ";
                    if (rowIdx >= 25 && rowIdx <= 26)
                        prefixName = "Energy Intensity (thousand Btu per 2009 dollar of GDP) ";
                    if (rowIdx == 29)
                        prefixName = "Price Indices ";
                    if (rowIdx >= 31 && rowIdx <= 32)
                        prefixName = "Price Indices Consumer Price Index (1982-84=1.00) ";
                    if (rowIdx >= 34 && rowIdx <= 37)
                        prefixName = "Price Indices Wholesale Price Index (1982=1.00) ";
                    if (rowIdx >= 40 && rowIdx <= 42)
                        prefixName = "Interest Rates (percent, nominal) ";
                    if (rowIdx >= 45 && rowIdx <= 51)
                        prefixName = "Value of Shipments (billion 2009 dollars) ";
                    if (rowIdx >= 54 && rowIdx <= 58)
                        prefixName = "Population and Employment (millions) ";
                    if (rowIdx >= 61 && rowIdx <= 63)
                        prefixName = "Key Labor Indicators ";
                    if (rowIdx >= 67 && rowIdx <= 70)
                        prefixName = "Key Indicators for Energy Demand ";

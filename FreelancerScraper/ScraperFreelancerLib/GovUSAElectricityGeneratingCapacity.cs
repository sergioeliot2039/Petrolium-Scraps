...
{
    public class GovUSAElectricityGeneratingCapacity : ExcelXlsxScrapeData
    {
            ...
            for (int rowIdx = firstRowWithData; rowIdx <= lastRow; rowIdx++)
            {
                ...
                for (int cellIdx = cellShift; cellIdx <= lastCellWithData; cellIdx++)
                {
                    ...
                    if (rowIdx >= 17 && rowIdx <= 26)
                        prefixName = "Electric Power Sector 2/ Power Only 2/ ";
                    if (rowIdx >= 28 && rowIdx <= 33)
                        prefixName = "Electric Power Sector 2/ Combined Heat and Power 9/ ";
                    if (rowIdx >= 36 && rowIdx <= 45)
                        prefixName = "Electric Power Sector 2/ Cumulative Planned Additions 10/ ";
                    if (rowIdx >= 47 && rowIdx <= 56)
                        prefixName = "Electric Power Sector 2/ Cumulative Unplanned Additions 10/ ";
                    if (rowIdx == 57)
                        prefixName = "Electric Power Sector 2/ Cumulative Electric Power Sector Additions 10/ ";
                    if (rowIdx >= 60 && rowIdx <= 68)
                        prefixName = "Electric Power Sector 2/ Cumulative Retirements 11/ ";
                    if (rowIdx == 70)
                        prefixName = "Electric Power Sector 2/ ";
                    if (rowIdx >= 73 && rowIdx <= 79)
                        prefixName = "Electric Power Sector 2/ End-Use Generators 12/ ";
                    if (rowIdx == 81)
                        prefixName = "Electric Power Sector 2/ Cumulative Capacity Additions 10/ ";
